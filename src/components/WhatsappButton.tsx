...
export function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 bg-linear-to-br from-green-500 to-green-600 text-white p-3 sm:p-4 rounded-full shadow-[0_10px_20px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.3)] hover:shadow-[0_5px_15px_rgba(0,0,0,0.3)] transition-all duration-200 group"
    >
